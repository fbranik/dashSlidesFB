...
title = "Constant Message Size Scenario"
titleBar = html.H4(title, className="text-white p-4 mb-2 text-left", style={"font-size" : "30px",
                                                                            "background": "slategray"})

big = [html.Img(src="assets/constMessageSizeBig.png", width="100%")]
small = [html.Img(src="assets/constMessageSizeSmall.png", width="100%")]
                ...
                dbc.Row(
                        [
                                ...
                                dbc.Col([html.P(["Large Messages", html.Br(), html.Br(),
                                                 html.B("- Communication Time remains relatively unchanged")], )],
                                        style={"textAlign"      : "left",
                                               "display"        : "flex",
                                               "align-items"    : "center",
                                               "justify-content": "center"}),
