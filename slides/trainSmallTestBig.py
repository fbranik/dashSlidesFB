...
modelScenario = "trainSmallTestBigModel"

arisDatasetToTrain = pd.read_csv(f'assets/{modelScenario}/trainSmallTestBigData.csv', sep=',')

importancesRead = pd.read_csv(f'assets/{modelScenario}/trainSmallTestBigImportances.csv', sep=',')
        ...
        children=[
                ...
                dbc.Row([
                        dbc.Col([
                                ...
                                dmc.Select(
                                        id='colorMeasurementsComparisonTSmallTBig',
                ...
                dbc.Row([
                        ...
                        dbc.Col([dcc.Graph(id="graphMeasurementsComparisonTSmallTBig")],
                                style={"padding"    : "20px", "textAlign": "center", "display": "flex",
                                       "align-items": "center", "justify-content": "center"}),
                        dbc.Col([html.Table(id="featureImportancesTSmallTBig",)],
...
title = 'Train Small/Test Big Model'
...
@app.callback(
        Output("graphMeasurementsComparisonTSmallTBig", "figure"),
        Input("colorMeasurementsComparisonTSmallTBig", "value"),
)
def generateMeasurementsComparisonChart(colorMeasurementsComparison):
    ...
    figMeasurementsComparison.write_image(
        mediaFolder + f"trainSmallTestBig_{colorMeasurementsComparison.replace(' ', '_')}_ModelVsActual.pdf")
    sleep(4)
    figMeasurementsComparison.write_image(
        mediaFolder + f"trainSmallTestBig_{colorMeasurementsComparison.replace(' ', '_')}_ModelVsActual.pdf")
...
@app.callback(
        Output("featureImportancesTSmallTBig", "children"),
        Input("colorMeasurementsComparisonTSmallTBig", "value"),
)
def generateMeasurementsComparisonChart(dummy):
    importances = importancesRead
    condition = (
