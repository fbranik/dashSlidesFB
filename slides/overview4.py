...
step1 = "Parallel application used as a basis."

step2 = "Set of experiments to better understand the behaviour of the data generator application."

step3 = "Construction of a dataset to be used in modeling."

step4 = "Construction of predictive models using various approaches."

step5 = "Evaluation of models using metrics and by attempting to predict the NAS BT benchmark"
        ...
        [
                dbc.Row(
                        [
                                dbc.Col(html.Div(dbc.Card(
                                        [
                                                dbc.CardHeader("Data Generator Application",
        ...
        [
                dbc.Row(
                        [
                                dbc.Col(html.Div(dbc.Card(
                                        [
                                                dbc.CardHeader("Model Construction",
                                                               style={"background": "slategray", "color": "white"}),
                                                dbc.CardBody(
                                                        [
                                                                html.P(step4,
        ...
        [
                dbc.Row(
                        [
                                dbc.Col(html.Div(dbc.Card(
                                        [
                                                dbc.CardHeader("Model Evaluation",
                                                               style={"background": "slategray", "color": "white"}),
                                                dbc.CardBody(
                                                        [
                                                                html.P(step5,
